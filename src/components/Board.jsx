...
const Board = () => {
    ...
    return (
        <>
            ...
            <div className="relative h-screen flex item-center justify-center mt-4">
                ...
                <h1 className='font-bold text-4xl my-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 md:text-5xl'>
                    ...
                    <div className="flex justify-between w-full px-3">
                        <p className="text-black text-lg font-bold mb-0">Movimientos:</p>
                        <p className="text-yellow-500 text-lg font-bold mb-0">{moves}</p>
                    </div>
                    <div className="grid grid-cols-4 gap-3 gjustify-center items-center px-3 py-5 my-3">
                        {cards.map(card => (
            ...
            transition-all mb-3" onClick={handleNewGame}>
                        Nuevo Juego
                    </button>
                </div>
